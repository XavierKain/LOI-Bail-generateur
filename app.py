...
<div style='text-align: center; color: gray; padding: 20px;'>
    <p>Générateur automatique de BAIL v1.0</p>
    <p>Développé par Xavier Kain</p>
    <p style='font-size: 0.8em; margin-top: 10px;'>Note: L'intégration avec LOI (tabs) sera ajoutée prochainement</p>
</div>
